    ...
    <Layout>
      <section className={styles.game}>
        ...
        <aside>
          <div>
            <h1>Current Level:</h1>
            <button name="0" disabled={localStorage.getItem('level-0-solution') === null} onClick={switchLevel}>Easy</button>
            <button name="1" disabled={localStorage.getItem('level-1-solution') === null} onClick={switchLevel}>Intermediate</button>
            <button name="2" disabled={localStorage.getItem('level-2-solution') === null} onClick={switchLevel}>Hard</button>
          </div>
          <button onClick={e=>{
            startGame(true);
          }}>Restart Game</button>
